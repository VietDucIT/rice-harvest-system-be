# Update rice price from DB to .csv files (4 rices: OM 5451, OM 18, IR 504, Đài thơm 8)
import pymongo
import csv
...
rices = ['OM 5451', 'OM 18', 'IR 504', 'Đài thơm 8']
om5451 = []
om18 = []
ir504 = []
daiThom8 = []
...
for x in mySrcCollection.find({'rice': {'$in': rices}}, {'_id': 0, 'price': 0, 'createdAt': 0, 'updatedAt': 0, '__v': 0}).sort('createdAt'):
  # don't get fields _id, price, createdAt, updatedAt, __v
  if x['rice'] == 'OM 5451':
